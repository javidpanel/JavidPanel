...
نسخه 0.8.6 اتصال نصب‌ها و لینک‌های قبلی را حفظ می‌کند و مدیریت کاربران، Fragment، آی‌پی تمیز، فهرست کشورها و نمایش پرچم نودها را در اختیار کاربر قرار می‌دهد.
...
- امکان نصب پنل مدیریت به‌صورت وب‌اپ روی موبایل
- نمایش زنده وضعیت پنل‌ها، درخواست‌های پشتیبانی و اعلان‌های مدیریتی
...
پنل مدیریت از مرورگر موبایل قابل نصب است و با نوار ناوبری پایین، اعلان‌های موبایل و بروزرسانی زنده اطلاعات، مانند یک اپ مستقل در دسترس قرار می‌گیرد.

<p align="center"><img src="assets/branding/javidpanel-app-icon.png" alt="آیکون اپ جاویدپنل" width="160"></p>
...
| **[اپ مدیریت موبایل](docs/fa/admin-app.md)** | نصب، ناوبری و اعلان‌های مدیریت |
